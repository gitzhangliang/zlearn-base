...
public class CreateSecretKey {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Map<String,Object> m = new Gson().fromJson(new String(plainText),Map.class);
            System.out.println("解密后明文===== " + new String(plainText));
            System.out.println(m.get("isLogin"));
...
class Us{
    ...
    private String mobile = "12";
    public static <T extends Object> String constructJsonStr(Map<String,T> map){
        ...
        StringBuilder builder1 = new StringBuilder(subStringLastBit(builder.toString()));
        builder1.append("}");
     ...
     * @return
     */
    public static String subStringLastBit(String str) {
